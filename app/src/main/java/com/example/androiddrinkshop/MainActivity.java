...
public class MainActivity extends AppCompatActivity {
        ...
        if (requestCode == REQUEST_CODE){
            ...
            if(result.getError() != null){
                ...
                if(result.getAccessToken() != null){
                    ...
                    alertDialog.show();
                    alertDialog.setMessage("Please Wait Loading......");

                    AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                        @Override
                        public void onSuccess(final Account account) {
                            mServices.checkUserExixts(account.getPhoneNumber().toString())
                                    .enqueue(new Callback<CheckUserResponse>() {
                                        @Override
                                        public void onResponse(Call<CheckUserResponse> call, Response<CheckUserResponse> response) {
                                            CheckUserResponse userResponse = response.body();
                                            if(userResponse.getExists()){
                                                //if exixts start new activity
                                                alertDialog.dismiss();
                                            }else{
                                                //register new user
                                                alertDialog.dismiss();
    ...
    private void showRegisterDialog(final String phone) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                waitingDialog.show();
                waitingDialog.setMessage("Please Wait Loading......");

                mServices.registerNewUser(phone,
    ...
    private void printKeyHash() {
        ...
        try{
            PackageInfo info = getPackageManager().getPackageInfo("com.example.androiddrinkshop", PackageManager.GET_SIGNATURES);
